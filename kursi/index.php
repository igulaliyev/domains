...
<head>
  ...
  <meta name="description" content="PROWID- лучшие курсы по веб программированию для студентов,курсы ip -телефонии, windows server, MsSQL, MySQL, VueJS, NodeJS, AJax">
...
<body>
  ...
  <main class="wraper__ flex flexDirCol">
    <?PHP
      @$id = $_GET['id'];
      if($id !== ' '){
        switch ($id) {
          ...
          case 'nodeJS':
            include_once("beg/backend/nodeJS.php");break;
          case 'backend_course':
            include_once("beg/backend/backend_course.php");break;
          case 'php':
            include_once("beg/backend/php.php");break;
          case 'contact':
