  ...
  <div class="htmlcss_wraper flex flexDirCol">
    ...
    <div class="htmlcss_body wraper_position flex flexDirCol">
      ...
      <details class="htmlcss_body_details">
        ...
        <div> &nbsp;&nbsp;Инструменты.</div>
        <div> &nbsp;&nbsp;Цели и задачи языка HTML</div>
        <div> &nbsp;&nbsp;HTML- разметка, понятия элементов</div>
        <div> &nbsp;&nbsp;Структура HTML- документа</div>
        <div> &nbsp;&nbsp;Атрибуты элементов</div>
        <div> &nbsp;&nbsp;Использование комментариев</div>
      ...
      <details class="htmlcss_body_details">
        ...
        <div>&nbsp;&nbsp;Пустые элементы</div>
        <div>&nbsp;&nbsp;Кавычки и значение атрибутов</div>
        <div>&nbsp;&nbsp;Элементы форматирования текста</div>
        <div>&nbsp;&nbsp;Новые и устаревшие теги</div>
        <div>&nbsp;&nbsp;Вложенные элементы</div>
        <div>&nbsp;&nbsp;Валидация HTML-документа</div>
        <div>&nbsp;&nbsp;Структуры элементы разметки</div>
        <div>&nbsp;&nbsp;Блочные и строчные элементы</div>
        <div>&nbsp;&nbsp;HTML 5</div>
        <div>&nbsp;&nbsp;HTML 5 плюсы</div>
        <div>&nbsp;&nbsp;Структура документа в HTML 5</div>
      ...
      <details class="htmlcss_body_details">
        ...
        <div>&nbsp;&nbsp;протокол Open Graph</div>
        <div>&nbsp;&nbsp;Meta -данные для  twitter</div>
        <div> &nbsp;&nbsp;Favicon</div>
      ...
      <details class="htmlcss_body_details">
        ...
        <div>&nbsp;&nbsp;Каскадирование и наследование</div>
        <div>&nbsp;&nbsp;Единицы измерения в css</div>
        <div>&nbsp;&nbsp;Селекторы</div>
        <div>&nbsp;&nbsp;Псевдоклассы и псевдоэлементы</div>
        <div>&nbsp;&nbsp;Свойства шрифтов</div>
        <div>&nbsp;&nbsp;Свойства текста</div>
      ...
      <details class="htmlcss_body_details">
        ...
        <div>&nbsp;&nbsp;Текстовые поля и кнопки</div>
        <div>&nbsp;&nbsp;Элементы выбора</div>
        <div>&nbsp;&nbsp;Другие элементы формы</div>
        <div>&nbsp;&nbsp;Дополнительные атрибуты элементов формы</div>
        <div> &nbsp;&nbsp;Лабараторная работа</div>
      </details>
    </div>
